...
public class PMDdoortodoor extends AppCompatActivity {
...
//    int day=Calendar.DAY_OF_WEEK -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pmddoortodoor);
        ...
        //It gets the mytext from the PMDRecycle Activity , it is what the user writes (Postal Code) in the input field
